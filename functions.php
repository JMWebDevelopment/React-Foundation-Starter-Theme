...
function theme_slug_scripts() {
    ...
    wp_localize_script( 'site-js', 'reactfoundationstarter', array(
 ...
 */
require('src/assets/functions/theme-options.php');
/**
 * Include custom functions
 */
require('src/assets/functions/menu-walkers.php');
/**
 * Register Sidebar
 */
...
add_filter( 'wp_title','theme_slug_react_title', 10, 3 );
function theme_slug_react_title( $title, $sep, $seplocation ) {
